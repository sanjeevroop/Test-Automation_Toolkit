...
WebUI.click(findTestObject('Navigations/Navigation - Database Details/span_Admin'))
...
WebUI.click(findTestObject('Navigations/Navigation - Database Details/a_Database Details'))
