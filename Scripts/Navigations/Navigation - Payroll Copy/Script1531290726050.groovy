...
WebUI.mouseOver(findTestObject('Navigations/Navigation - Payroll Copy/button_Your Setup'))

WebUI.delay(1)

WebUI.click(findTestObject('Navigations/Navigation - Payroll Copy/a_Payroll Copy'))

WebUI.click(findTestObject('Object Repository/Navigations/Navigation - Payroll Copy/label_Copy From'))
