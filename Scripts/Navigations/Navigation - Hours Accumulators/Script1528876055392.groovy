...
WebUI.verifyElementPresent(findTestObject('Navigations/Navigation - Hours Accumulators/button_Save'), 0)

WebUI.doubleClick(findTestObject('Navigations/Navigation - Hours Accumulators/input'))
