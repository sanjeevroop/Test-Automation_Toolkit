...
WebUI.mouseOver(findTestObject('Navigations/Navigation - Holiday Rate Calculation/button_Your Setup'))

WebUI.delay(1)

WebUI.mouseOver(findTestObject('Navigations/Navigation - Holiday Rate Calculation/a_Your Absence Rules'))

WebUI.delay(1)

WebUI.click(findTestObject('Navigations/Navigation - Holiday Rate Calculation/a_Holiday Rate Calculation'))

WebUI.click(findTestObject('Object Repository/Navigations/Navigation - Holiday Rate Calculation/label_Accrual Calculation Meth'))
