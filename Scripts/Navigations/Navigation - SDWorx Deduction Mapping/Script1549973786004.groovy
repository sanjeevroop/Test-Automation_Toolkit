...
WebUI.click(findTestObject('Navigations/Navigation - SDWorx Deduction Mapping/label_SDWorx Deduction Mapping'))
...
WebUI.verifyTextPresent('SDWorx Deduction Mapping', false)
