...
WebUI.click(findTestObject('Navigations/Navigation - Probation Label/Page_Implementation Toolkit/a_Probation'))

WebUI.delay(2)

WebUI.click(findTestObject('Navigations/Navigation - Probation Label/Page_Implementation Toolkit/a_Probation Labels'))
