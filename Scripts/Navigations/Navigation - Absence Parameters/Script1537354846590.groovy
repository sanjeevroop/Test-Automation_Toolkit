...
WebUI.callTestCase(findTestCase('Dropdown Lists/Select Organisation'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyTextPresent('DAYS', false) //to change text when absence parameters is back up
