...
WebUI.setText(findTestObject('Fields Validation/Department Details/Invalid Entry - Department Value/input_DepartmentDescription0'), 'Auto')

WebUI.delay(1)

WebUI.setText(findTestObject('Fields Validation/Department Details/Invalid Entry - Department Value/input_ReferenceCode0'), '56')
...
//WebUI.takeScreenshot('Screenshot/Department Details Screen/DepartmentDetails5.png')
