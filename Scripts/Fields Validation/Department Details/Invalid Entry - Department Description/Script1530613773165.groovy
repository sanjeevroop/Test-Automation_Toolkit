...
WebUI.setText(findTestObject('Fields Validation/Department Details/Invalid Entry - Department Description/input_DepartmentDescription0'), 'Test123456tyrtyui')

WebUI.delay(2)

WebUI.setText(findTestObject('Fields Validation/Department Details/Invalid Entry - Department Description/input_ReferenceCode0'), '231')
...
//WebUI.takeScreenshot('Screenshot/Department Details Screen/DepartmentDetails7.png')
