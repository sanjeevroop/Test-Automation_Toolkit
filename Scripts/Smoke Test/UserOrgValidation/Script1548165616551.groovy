...
WebUI.setText(findTestObject('Object Repository/Login/input_Email'), findTestData('Login').getValue('Username', 3))

WebUI.setText(findTestObject('Object Repository/Login/input_Password'), findTestData('Login').getValue('Password', 3))
