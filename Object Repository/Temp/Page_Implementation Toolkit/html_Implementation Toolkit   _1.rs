...
<WebElementEntity>
   ...
   <name>html_Implementation Toolkit   _1</name>
   <tag></tag>
   <elementGuidId>902c16d5-7888-44ed-a4d0-bee65c8af966</elementGuidId>
    ...
    function sortTable(n) {
        ...
        (function($) {
            $.fn.swhgLoad = function(url, containerId, callback) {
                ...
                $('&lt;div>&lt;/div>').load(url + ' ' + containerId, function(data, status, xhr) {
